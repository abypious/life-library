...
public class ViewUser extends javax.swing.JFrame {
    ...
    String searchString = jTextField1.getText();
    String sql = "SELECT * FROM user WHERE name LIKE ? OR address LIKE ? OR phone LIKE ? OR email LIKE ?";

    try {
        PreparedStatement pst = c.prepareStatement(sql);
        String query = "%" + searchString + "%";
        pst.setString(1, query); // Search by name
        pst.setString(2, query); // Search by address
        pst.setString(3, query); // Search by phone
        pst.setString(4, query); // Search by email
